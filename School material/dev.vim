...
silent only
cd /mnt/d/Satan/Programs/C\#/School\ material
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +43 Program.cs
badd +0 term://.//1388:/bin/bash
badd +0 memory.json
badd +1 settings.json
badd +0 term://.//1448:/bin/bash
badd +1 School\ material.csproj
badd +0 term://.//1475:/bin/bash
argglobal
%argdel
$argadd Program.cs
set stal=2
...
wincmd w
argglobal
if bufexists("term://.//1388:/bin/bash") | buffer term://.//1388:/bin/bash | else | edit term://.//1388:/bin/bash | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("term://.//1448:/bin/bash") | buffer term://.//1448:/bin/bash | else | edit term://.//1448:/bin/bash | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 96 + 97) / 194)
exe '3resize ' . ((&lines * 27 + 29) / 58)
tabedit School\ material.csproj
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
wincmd w
argglobal
if bufexists("term://.//1475:/bin/bash") | buffer term://.//1475:/bin/bash | else | edit term://.//1475:/bin/bash | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
